...
def cakes(recipe: dict, ingredients: dict):
    if any(part not in ingredients for part in recipe):
        return 0
    amounts = {part: ingredients[part] // recipe[part] for part in recipe}
    return min(amounts.values())
